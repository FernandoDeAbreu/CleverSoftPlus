...
namespace CleverSoft
{
    public partial class frm_Menux : Form
    {
        ...
        private void verificapermissoes()
        {
            ...
            int con = 0;
            foreach (ToolStripItem botao in Consultar.Items)
            {
                conexao.Abre_Conexao();
                string SQLCunsultaEmpr = "SELECT * FROM TBPERMISSAO WHERE IDFUNC = '" + idFunc + "' AND NOMEROTINA = '" + botao.Text + "'";
            ...
            int cop = 0;
            foreach (ToolStripItem botao in Comprar.Items)
            {
                conexao.Abre_Conexao();
                string SQLCunsultaEmpr = "SELECT * FROM TBPERMISSAO WHERE IDFUNC = '" + idFunc + "' AND NOMEROTINA = '" + botao.Text + "'";
            ...
            foreach (ToolStripItem botao in Vender.Items)
            {
                conexao.Abre_Conexao();
                string SQLCunsultaEmpr = "SELECT * FROM TBPERMISSAO WHERE IDFUNC = '" + idFunc + "' AND NOMEROTINA = '" + botao.Text + "'";
        ...
        {
            frm_ContaGerencial fm = new frm_ContaGerencial();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
        }
        ...
        {
            frm_ContasPagar fm = new frm_ContasPagar();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
        }
        ...
        {
            frm_ContasReceber fm = new frm_ContasReceber();
            fm.FormClosed += new FormClosedEventHandler(MostrarFormLogoAlCerrarForms);
            AbrirFormEnPanel(fm);
        }
