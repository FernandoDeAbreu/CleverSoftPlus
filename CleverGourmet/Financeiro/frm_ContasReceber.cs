...
{
    public partial class frm_ContasReceber : Modelo
    {
        ...
        public override void pesquisar_Registro()
        {
            ...
            {
                dtPagamento = " F.DTPGTO  not null AND ";
            }
        ...
        public override void editar_Registro()
        {
            ...
            //{
            //    MessageBox.Show("O Registro selecionado está vinculado a outros registros, não será possivel editar ou extornar através dessa rotina.", "Clever Sistema", MessageBoxButtons.OK);
            //    return;
            //}
            try
            {
        ...
        public override void excluir_Registro()
        {
            try
            {
                ...
                if (MessageBox.Show("Realmente deseje excluir o item selecionado?", "Clever Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    conexao.Abre_Conexao();
                    string SQLCunsultaEmpr = "INSERT INTO TBCR_ex ( TIPO, IDFILIAL, IDPARCEIRO, IDMOEDA, IDCONTA, IDCONTAGERENCIAL, HISTORICO, NUMDOC, DTLANC, DTVENC, DTCOMPETENCIA, DTPGTO, VALOR, VLRDESC, VLRJUROS, VLRTOTAL, VLREXTENSO, IDVENDA, STATUS)" +
                                             ...
                                             "FROM TBCR WHERE ID = " + id_registro;
                    ...
                    SQLCunsultaEmpr = "DELETE FROM TBCR WHERE ID = " + id_registro;
        ...
        private void calcularTotal()
    {
        ...
        public override void relatorio1()
        {
            try
            {
                ...
                a.Arquivo_rdlc = "Rpv_CR_Simples.rdlc";
        ...
        public override void relatorio2()
        {
            ...
            {
                frm_Relatorio a = new frm_Relatorio();
                a.Arquivo_rdlc = "Rpv_CR_Detalhado.rdlc";
                a.Sql_Relatorio1 = this.SQLCunsultaEmpr;
                a.Dataset_Relatorio1 = "DataSet_CR";
                a.ShowDialog();
            }
        ...
        public override void relatorio3()
        {
            ...
            {
                frm_Relatorio a = new frm_Relatorio();
                a.Arquivo_rdlc = "Rpv_CR_Recibo.rdlc";
                a.Sql_Relatorio1 = this.SQLCunsultaEmpr;
                a.Dataset_Relatorio1 = "DataSet_CR";
                a.ShowDialog();
            }
        ...
        private void tboxTipoData_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tboxTipoData.Text == " ")
            {
                tboxDTIni.Enabled = false;
                tboxDtFim.Enabled = false;
            }
            else
            {
                tboxDTIni.Enabled = true;
                tboxDtFim.Enabled = true;
            }
        }
