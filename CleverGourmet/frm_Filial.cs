...
{
    public partial class frm_Filial : Modelo
    {
        ...
        private void Iniciar_Form()
        {
            ...
            DataGridViewTextBoxColumn col_RODAPECUPOM = new DataGridViewTextBoxColumn();
            col_RODAPECUPOM.Name = "RODAPECUPOM";
            col_RODAPECUPOM.HeaderText = "RODAPE CUPOM";
            col_RODAPECUPOM.Width = 250;
            dgv_resultado_pesquisa.Columns.Add(col_RODAPECUPOM);
        ...
        public override void pesquisar_Registro()
        {
            ...
            SQLCunsultaEmpr = "SELECT * FROM TBFILIAL WHERE DTEXCLUSAO IS NULL AND RAZAOSOCIAL " + nome + " AND CNPJ_CPF " + cpf;
            ...
            while (conexao.dataReader.Read())
            {
                ...
                dgv_resultado_pesquisa.Rows[o].Cells["RODAPECUPOM"].Value = conexao.dataReader["RODAPECUPOM"].ToString();
        ...
        public override void gravar_Registro()
        {
            ...
            try
            {
                if (tboxmatricula.Text == "")
                {
                    #region INSERT
                    conexao.Abre_Conexao();
                    string SQLCunsultaEmpr = "INSERT INTO TBFILIAL " +
                                                 "(RAZAOSOCIAL,                " +
                                                 " TIPOPESSOA,          " +
                                                 " CNPJ_CPF,            " +
                                                 " IE_RG,               " +
                    ...
                    conexao.cmd.Parameters.AddWithValue("RODAPECUPOM", tbox_Rodade.Text);
                ...
                else
                {
                    #region UPDATE
                    conexao.Abre_Conexao();
                    string SQLCunsultaEmpr = "UPDATE TBFILIAL SET " +
        ...
        public override void editar_Registro()
        {
            try
            {
                ...
                tbox_Rodade.Text = dgv_resultado_pesquisa.CurrentRow.Cells["RODAPECUPOM"].Value.ToString();
        ...
        public override void excluir_Registro()
        {
            try
            {
                if (MessageBox.Show("Realmente deseje excluir o item selecionado?", "Clever Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    conexao.Abre_Conexao();
                    string SQLCunsultaEmpr = "UPDATE TBFILIAL SET DTEXCLUSAO = '" + DateTime.Now + "' WHERE ID = " + id_registro;
